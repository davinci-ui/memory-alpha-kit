...
OLLAMA_EMBED_URL = os.environ.get("OLLAMA_URL", "http://localhost:11434") + "/api/embed"
SEARXNG_URL = os.environ.get("SEARXNG_URL", "http://localhost:8890")
KB_COLLECTION = "memories_tr"
...
def main():
    ...
    for web_result in web_results:
        ...
        if args.store_new:
            ...
            metadata = {
                "domain": domain,
                "path": f"{domain}/Web/{re.sub('[^A-Za-z0-9_ -]', '', title)[:30]}",
                "subjects": subjects,
                "category": "reference",
